   ...
   onSubmit(): void {
        ...
        this.auth.login({ email: this.email, password: this.password }).subscribe({
            ...
            error: (err) => {
                ...
                this.serverError.set(err.message ?? 'Credenciales incorrectas.');
            }
        });
    }
}
