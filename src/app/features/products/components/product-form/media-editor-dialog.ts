...
@Component({
    ...
    standalone: true,
    imports: [CommonModule, FormsModule, ButtonModule, SelectModule, CheckboxModule, DialogModule, MediaPickerComponent],
    template: `
                    ...
                    <div class="flex flex-col gap-4">
                        <div class="flex items-center gap-3">
                            <div class="flex-1">
                                ...
                                <p-select [ngModel]="m.type" (ngModelChange)="onTypeChange($event)" [options]="mediaTypeOptions()" optionLabel="label" optionValue="value" class="w-full" />
                            </div>
                            <div class="flex-1">
